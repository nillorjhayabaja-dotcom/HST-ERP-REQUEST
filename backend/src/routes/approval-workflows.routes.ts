...
router.get(
  "/:id",
  authenticate,
  requirePermission("approval_workflows", "read"),
  async (req, res) => {
    try {
...
router.post(
  "/",
  authenticate,
  requirePermission("approval_workflows", "create"),
  async (req, res) => {
    try {
...
router.put(
  "/:id",
  authenticate,
  requirePermission("approval_workflows", "update"),
  async (req, res) => {
    try {
      const { name, description, module, is_active, steps } = req.body;
...
router.delete(
  "/:id",
  authenticate,
  requirePermission("approval_workflows", "delete"),
  async (req, res) => {
    try {
