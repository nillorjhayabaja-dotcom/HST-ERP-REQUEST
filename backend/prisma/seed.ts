...
async function main() {
  ...
  const permissions = [
    ...
    { module: 'gate_passes', action: 'read_all', description: 'View all gate passes across departments' },
  ...
  const rolePermissions: Record<string, string[]> = {
    ...
    system_administrator: [
      'dashboard:read', 'employees:read', 'employees:create', 'employees:update', 'employees:delete',
      ...
      'users:read', 'users:create', 'users:update', 'users:delete', 'users:reset_password', 'users:unlock_account',
      'approval_workflows:read', 'approval_workflows:create', 'approval_workflows:update', 'approval_workflows:delete',
      'approval_requests:read', 'approval_requests:create', 'approval_requests:update', 'approval_requests:approve',
      'notifications:read', 'notifications:update', 'notifications:delete',
      'audit_logs:read', 'audit_logs:export',
      'control_numbers:read', 'control_numbers:create', 'control_numbers:update',
      'gate_passes:read', 'gate_passes:create', 'gate_passes:update', 'gate_passes:delete', 'gate_passes:approve', 'gate_passes:release', 'gate_passes:read_all',
      'gate_pass_settings:read', 'gate_pass_settings:update',
      'leave:read', 'leave:create', 'leave:update', 'leave:approve', 'leave:read_all',
      'mrf:read', 'mrf:create', 'mrf:update', 'mrf:approve', 'mrf:read_all',
      'purchase_requests:read', 'purchase_requests:create', 'purchase_requests:update', 'purchase_requests:approve', 'purchase_requests:read_all',
      'visitors:read', 'visitors:create', 'visitors:update', 'visitors:check_in', 'visitors:check_out', 'visitors:read_all',
      'vehicles:read', 'vehicles:create', 'vehicles:update', 'vehicles:delete', 'vehicles:assign', 'vehicles:manage', 'vehicles:read_all',
      'assets:read', 'assets:create', 'assets:update', 'assets:delete', 'assets:borrow', 'assets:approve', 'assets:read_all',
      'reports:read_own', 'reports:read_team', 'reports:read_department', 'reports:read_company', 'reports:export',
      'system:read',
    ],
    it_support: [
      'dashboard:read',
      'users:read', 'users:reset_password', 'users:unlock_account',
      'audit_logs:read',
      'notifications:read', 'notifications:update',
    ],
    executive: [
      'dashboard:read',
      'approval_requests:read', 'approval_requests:approve',
      'reports:read_company', 'reports:export',
      'notifications:read', 'notifications:update',
      'gate_passes:read', 'gate_passes:read_all',
      'leave:read_all',
      'mrf:read_all',
    ...
    department_manager: [
      'dashboard:read',
      'approval_requests:read', 'approval_requests:approve',
      'reports:read_department', 'reports:export',
      'notifications:read', 'notifications:update',
      'employees:read',
      'gate_passes:read', 'gate_passes:approve',
      'leave:read', 'leave:approve',
      'mrf:read', 'mrf:approve',
      'purchase_requests:read', 'purchase_requests:approve',
    ...
    gad: [
      ...
      'gate_passes:read', 'gate_passes:approve',
      'gate_pass_settings:read', 'gate_pass_settings:update',
      'vehicles:read', 'vehicles:assign', 'vehicles:manage',
      'reports:read_department', 'reports:export',
      'notifications:read', 'notifications:update',
      'approval_requests:read', 'approval_requests:approve',
    ],
    hr_officer: [
      ...
      'leave:read', 'leave:approve', 'leave:read_all',
    ...
    security_guard: [
      'dashboard:read',
      'gate_passes:read', 'gate_passes:release', 'gate_passes:verify_qr',
      'visitors:check_in', 'visitors:check_out',
      'vehicles:read',
      'notifications:read', 'notifications:update',
    ],
    purchasing_officer: [
      'dashboard:read',
      'purchase_requests:read', 'purchase_requests:read_all',
    ...
    warehouse_officer: [
      'dashboard:read',
      'assets:read', 'assets:create', 'assets:update', 'assets:read_all',
      'notifications:read', 'notifications:update',
    ],
    vehicle_coordinator: [
      'dashboard:read',
      'vehicles:read', 'vehicles:update', 'vehicles:assign', 'vehicles:manage', 'vehicles:read_all',
      'notifications:read', 'notifications:update',
      'reports:read_department',
    ],
    auditor: [
  ...
  const departments = [
    ...
    { code: 'GAD', name: 'General Administration', description: 'General administration department' },
