    ...
    data: [
      {
        ...
        gate_pass_type_id: (await prisma.gatePassType.findFirst({ where: { code: 'OFFICIAL_BUSINESS' } }))!.id,
      ...
      },
      {
        ...
        gate_pass_type_id: (await prisma.gatePassType.findFirst({ where: { code: 'WITH_VEHICLE' } }))!.id,
      ...
      },
      {
        ...
        gate_pass_type_id: (await prisma.gatePassType.findFirst({ where: { code: 'PERSONAL' } }))!.id,
        employee_id: employee1.id,
        status: 'draft',
